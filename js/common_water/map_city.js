...
function change_area_level(action) {
    var area_level = ["ALL", "City", "Station"];
    var index = -1;
    ...
    var map_opts = {
        ...
        tooltip: {
            ...
            formatter: function () {
                ...
                return area_text + "<br />" + create_date + 
                    ((map_legend_sub_text == null) ? current_map_value_name : map_legend_sub_text)
                    + ": " + value;
            }
        },
...
function change_year_data(sy, sm, chart) {
    ...
    if (map_object) {
        ...
        var title = "" + area_text + "  " + current_site_name + " " + (sy - 1911).toString() + " 年 " + sm + " 月";
        if (map_title_year == true) {
            title = "" + area_text + "  " + current_site_name + " " + (sy - 1911).toString() + " 年 ";
        }
