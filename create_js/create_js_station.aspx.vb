Partial Class create_js_create_js_co
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        create_all("臭氧", "chart_o3")
        create_all("細懸浮微粒", "chart_pm25")
        create_all("二氧化氮", "chart_no2")
        create_all("一氧化碳", "chart_co")
        create_all("二氧化硫", "chart_so2")
    ...
    ''' 建立全台空品區
    ''' </summary>
    Private Sub create_all(type As String, object_name As String)
        ...
        Dim dt_site = (From t In dc.AirQualityMonth
                       ...
                       Where t.ITEMNAME = type And t.MONTHLYVALUE IsNot Nothing
        ...
        Dim result = "var map_" & object_name & " = [ " & vbCrLf &
            String.Join("," & vbCrLf, area_json.ToArray()) & " ];"

        Dim path As String = Server.MapPath("../js/station/map_" & object_name & ".js")
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        create_data("臭氧", "chart_o3")
        create_data("細懸浮微粒", "chart_pm25")
        create_data("二氧化氮", "chart_no2")
        create_data("一氧化碳", "chart_co")
        create_data("二氧化硫", "chart_so2")

        Response.Write("creae  data ok _" & Now.ToString())
    End Sub

    Private Sub create_data(type As String, object_name As String)
        ...
        Dim result As String = "var " & object_name & " = " & vbCrLf & json & ";"

        Dim path As String = Server.MapPath("../js/station/" & object_name & ".js")
        Dim fn As New System.IO.FileStream(path, IO.FileMode.Create)
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim path As String = Server.MapPath("../js/so2_p2/co_oil.js")
        Dim fn As New System.IO.FileStream(path, IO.FileMode.Create)
        Dim sw As New System.IO.StreamWriter(fn, System.Text.Encoding.UTF8)
        sw.Write(result)
        sw.Close()
