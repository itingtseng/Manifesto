...
Public Class WaterData_p1
    ...
    Public Function GetDataTable(item As String) As Data.DataTable Implements IWaterData.GetDataTable
        ...
        Dim sql As String = " select * from WaterMonthValue " &
    ...
    Public Function create_data(ITEM_NAME As String, Dir As String, FileName As String,
                            start_date As DateTime?, end_date As DateTime?, data_unit As IWaterData.class_kind_json.enum_data_unit, Optional gropu_type As String = "avg") As String Implements IWaterData.create_data
    ...
    Private Function get_area_json(leval As String, item As String,
                                    sd As DateTime, ed As DateTime, data_unit As IWaterData.class_kind_json.enum_data_unit, Optional gropu_type As String = "avg") As String() Implements IWaterData.get_area_json
