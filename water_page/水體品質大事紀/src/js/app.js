...
var leftEvents = [
    ...
    new Event("水污染防治法第六次修正", moment("2015-02-04"), moment(), {
        name: '2015-02',
        context: {}
    }),
    new Event("水污染防治法第五次修正", moment("2007-12-12"), moment("2015-02-03"), {
        name: '2007-12',
        context: {}
    }),
...
var rightEvents = [
    ...
    new Event("有害健康物質之種類第1次修正、違反水污染防治法罰鍰額度裁罰準則第2次修正、水污染防治措施及檢測申報管理辦法第4次修正、水污染防治法施行細則第10次修正", moment("2015-01-01"), moment("2015-12-31"), {
        name: '',
        context: {}
    }),
    new Event("水污染防治措施及檢測申報管理辦法第2、3次修正。", moment("2013-01-01"), moment("2013-12-31"), {
        name: '',
        context: {}
    }),
    new Event("公告有害健康物質之種類", moment("1992-01-01"), moment("1992-12-31"), {
        name: '1992-01',
        context: {}
    }),
    new Event("水污染防治措施計畫及許可申請審查辦法第1次修正、違反水污染防治法罰鍰額度裁罰準則第1次修正", moment("2012-01-01"), moment("2012-12-31"), {
        name: '2012-01',
        context: {}
    }),
    new Event("水污染防治措施及檢測申報管理辦法第1次修正", moment("2010-01-01"), moment("2010-12-31"), {
        name: '2010-01',
        context: {}
    }),
    new Event("全國首例核定「桃園市新街溪及埔心溪總量管制方式」、訂定應揭露排放廢(污)水可能含有污染物、濃度與排放量之事業、水污染防治措施計畫及許可申請審查辦法第2次修正", moment("2016-01-01"), moment(), {
        name: '2016-01',
        context: {}
    }),
    ...
    new Event("發布「預鑄式建築物污水處理設施管理辦法」", moment("2003-01-01"), moment("2003-12-31"), {
        name: '2003-01',
        context: {}
    }),
...
function ViewModel() {
    ...
    this.currentScale = ko.observable(1.0);
