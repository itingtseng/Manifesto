...
var leftEvents = [
    ...
    new Event("水污染防治費收費辦法訂定發布", moment("2006-01-01"), moment("2006-12-31"), {
        name: '',
        context: {}
    }),
    new Event("事業廢(污)水排放地面水體許可辦法", moment("2003-01-01"), moment("2003-12-31"), {
        name: '',
        context: {}
    }),
    new Event("河川整治年", moment("2002-01-01"), moment("2002-12-31"), {
        name: '',
        context: {}
    }),
    new Event("臺灣地區河川流域及海洋經營管理方案", moment("2001-01-01"), moment("2007-12-31"), {
        name: '',
        context: {}
    }),
    new Event("發布廢(污)水排放收費辦法", moment("1998-01-01"), moment("1998-12-31"), {
        name: '',
        context: {}
    }),
    new Event("建置事業廢水管制資訊管理系統", moment("1995-01-01"), moment("1995-12-31"), {
        name: '',
        context: {}
    }),
    new Event("推動許可、技師簽證及誠實申報制度", moment("1993-01-01"), moment("1993-12-31"), {
        name: '',
        context: {}
    }),
    ...
    new Event("重大污染源機動稽查專案管制", moment("1991-01-01"), moment("1991-12-31"), {
        name: '',
        context: {}
    }),
    new Event("重要公民營事業廢水管制計畫", moment("1987-01-01"), moment("1987-12-31"), {
        name: '',
        context: {}
    }),
...
var rightEvents = [
    ...
    new Event("建置河川污染整治績效指標", moment("2009-01-01"), moment("2009-12-31"), {
        name: '',
        context: {}
    }),
    ...
    new Event("成立淡水河系污染整治計畫推動小組推動一縣市一河川，污染防治方案、清流計畫、甘泉計畫、碧海計畫", moment("1988-01-01"), moment("1988-12-31"), {
        name: '',
        context: {}
    }),
